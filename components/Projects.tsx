...
export default function Projects({}: Props) {
  return (
    <div className="h-screen flex flex-col overflow-hidden relative text-center max-w-full px-10 justify-evenly mx-auto items-center">
      <motion.h3
        initial={{
          opacity: 0,
        }}
...
<p className="absolute uppercase text-neutral-400 tracking-[10px] top-32 pr-4">Scroll to see my work</p>
